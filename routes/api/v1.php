...
Route::prefix('v1')->name('v1.')->group(function () {
    ...
    Route::get('cacheInvalidationRevision', fn(): string => MediaStorage::ORIGINALS->getDisk()->get(MediaStorage::getCacheInvalidationFilePath()) ?? 0)->name('getCacheInvalidationRevision');
});
