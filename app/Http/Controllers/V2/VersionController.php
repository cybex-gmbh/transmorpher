...
use App\Http\Requests\V2\SetVersionRequest;
...
class VersionController extends Controller
{
     ...
     * @return JsonResponse
     */
    public function setVersion(#[CurrentUser] User $user, SetVersionRequest $request, Media $media, Version $version): JsonResponse
    {
