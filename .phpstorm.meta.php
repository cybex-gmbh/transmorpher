...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.s3Originals.secret' => 'NULL',
            ...
            'filesystems.disks.s3ImageDerivatives.secret' => 'NULL',
            ...
            'filesystems.disks.s3DocumentDerivatives.secret' => 'NULL',
            ...
            'filesystems.disks.s3VideoDerivatives.secret' => 'NULL',
            ...
            'filesystems.links./var/www/html/public/videos' => 'string',
            ...
            'protector.remoteEndpoint.serverUrl' => 'string',
            ...
            'queue.connections.sqs-fifo.secret' => 'NULL',
...
'app.aliases.InterventionImage','app.aliases.Optimize','app.aliases.Transcode','app.aliases.Transform','auth.defaults.guard',
...
'cache.stores.failover.stores','cache.prefix','chunk-upload.storage.chunks','chunk-upload.storage.disk','chunk-upload.clear.timestamp',
...
'chunk-upload.handlers.override','cors.paths','cors.allowed_methods','cors.allowed_origins','cors.allowed_origins_patterns',
...
'database.redis.cache.backoff_base','database.redis.cache.backoff_cap','decoder.nvidia-cuda','encoder.cpu-h264','encoder.cpu-hevc',
'encoder.nvidia-h264','encoder.nvidia-hevc','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.localOriginals.driver',
'filesystems.disks.localOriginals.root','filesystems.disks.localOriginals.throw','filesystems.disks.localOriginals.report','filesystems.disks.localImageDerivatives.driver','filesystems.disks.localImageDerivatives.root',
'filesystems.disks.localImageDerivatives.throw','filesystems.disks.localImageDerivatives.report','filesystems.disks.localDocumentDerivatives.driver','filesystems.disks.localDocumentDerivatives.root','filesystems.disks.localDocumentDerivatives.throw',
'filesystems.disks.localDocumentDerivatives.report','filesystems.disks.localVideoDerivatives.driver','filesystems.disks.localVideoDerivatives.root','filesystems.disks.localVideoDerivatives.url','filesystems.disks.localVideoDerivatives.visibility',
'filesystems.disks.localVideoDerivatives.throw','filesystems.disks.localVideoDerivatives.report','filesystems.disks.s3Originals.driver','filesystems.disks.s3Originals.root','filesystems.disks.s3Originals.key',
'filesystems.disks.s3Originals.secret','filesystems.disks.s3Originals.region','filesystems.disks.s3Originals.bucket','filesystems.disks.s3Originals.url','filesystems.disks.s3Originals.endpoint',
'filesystems.disks.s3Originals.use_path_style_endpoint','filesystems.disks.s3Originals.throw','filesystems.disks.s3Originals.report','filesystems.disks.s3ImageDerivatives.driver','filesystems.disks.s3ImageDerivatives.root',
'filesystems.disks.s3ImageDerivatives.key','filesystems.disks.s3ImageDerivatives.secret','filesystems.disks.s3ImageDerivatives.region','filesystems.disks.s3ImageDerivatives.bucket','filesystems.disks.s3ImageDerivatives.url',
'filesystems.disks.s3ImageDerivatives.endpoint','filesystems.disks.s3ImageDerivatives.use_path_style_endpoint','filesystems.disks.s3ImageDerivatives.throw','filesystems.disks.s3ImageDerivatives.report','filesystems.disks.s3DocumentDerivatives.driver',
'filesystems.disks.s3DocumentDerivatives.root','filesystems.disks.s3DocumentDerivatives.key','filesystems.disks.s3DocumentDerivatives.secret','filesystems.disks.s3DocumentDerivatives.region','filesystems.disks.s3DocumentDerivatives.bucket',
'filesystems.disks.s3DocumentDerivatives.url','filesystems.disks.s3DocumentDerivatives.endpoint','filesystems.disks.s3DocumentDerivatives.use_path_style_endpoint','filesystems.disks.s3DocumentDerivatives.throw','filesystems.disks.s3DocumentDerivatives.report',
'filesystems.disks.s3VideoDerivatives.driver','filesystems.disks.s3VideoDerivatives.root','filesystems.disks.s3VideoDerivatives.key','filesystems.disks.s3VideoDerivatives.secret','filesystems.disks.s3VideoDerivatives.region',
'filesystems.disks.s3VideoDerivatives.bucket','filesystems.disks.s3VideoDerivatives.url','filesystems.disks.s3VideoDerivatives.endpoint','filesystems.disks.s3VideoDerivatives.use_path_style_endpoint','filesystems.disks.s3VideoDerivatives.throw',
'filesystems.disks.s3VideoDerivatives.report','filesystems.links./var/www/html/public/storage','filesystems.links./var/www/html/public/videos','hashing.driver','hashing.bcrypt.rounds',
'hashing.bcrypt.verify','hashing.argon.memory','hashing.argon.threads','hashing.argon.time','hashing.argon.verify',
'hashing.rehash_on_login','image.driver','image.options.autoOrientation','image.options.decodeAnimation','image.options.blendingColor',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','protector.fileName','protector.maxPacketLength',
...
'protector.chunkSize','protector.httpTimeout','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'queue.connections.deferred.driver','queue.connections.failover.driver','queue.connections.failover.connections','queue.connections.sqs-fifo.driver','queue.connections.sqs-fifo.key',
'queue.connections.sqs-fifo.secret','queue.connections.sqs-fifo.prefix','queue.connections.sqs-fifo.queue','queue.connections.sqs-fifo.suffix','queue.connections.sqs-fifo.region',
'queue.connections.sqs-fifo.after_commit','queue.batching.database','queue.batching.table','queue.failed.driver','queue.failed.database',
...
'session.partitioned','transmorpher.dev_mode','transmorpher.store_derivatives','transmorpher.disks.originals','transmorpher.disks.imageDerivatives',
'transmorpher.disks.documentDerivatives','transmorpher.disks.videoDerivatives','transmorpher.transform_class','transmorpher.convert_classes.jpg','transmorpher.convert_classes.png',
'transmorpher.convert_classes.gif','transmorpher.convert_classes.webp','transmorpher.document_remove_metadata','transmorpher.document_default_ppi','transmorpher.transcode_class',
'transmorpher.decoder','transmorpher.encoder','transmorpher.representations','transmorpher.cdn_helper','transmorpher.aws.key',
'transmorpher.aws.secret','transmorpher.aws.region','transmorpher.aws.cloudfront_distribution_id','transmorpher.signing_keypair','transmorpher.media_handlers.image',
'transmorpher.media_handlers.document','transmorpher.media_handlers.video','transmorpher.cache_invalidation_counter_file_path','view.paths','view.compiled',
...
'v1.getCacheInvalidator','getImageDerivative','getDocumentDerivative','storage.local',);
...
'new-version-notice.subject','new-version-notice.title','new-version-notice.new_api_version_released','new-version-notice.update_client_implementations','new-version-notice.check_out_on_github',
'responses.cdn_invalidation_failed','responses.deletion_successful','responses.image_upload_successful','responses.image_version_set','responses.document_upload_successful',
'responses.document_version_set','responses.transcoding_aborted','responses.transcoding_failed','responses.transcoding_job_dispatch_failed','responses.transcoding_successful',
'responses.upload_slot_created','responses.versions_retrieved','responses.video_version_set','responses.video_upload_successful','responses.write_failed',
'responses.file_name_invalid','responses.file_name_invalid_only_spaces','responses.non_matching_identifier','version-deprecation-notice.subject','version-deprecation-notice.title',
'version-deprecation-notice.version_soon_deprecated','version-deprecation-notice.update_client_implementations',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'VIDEO_TRANSCODING_WORKERS_AMOUNT','APP_SERVICE','DOCKER_CONTAINER_NAME','FORWARD_DB_PORT','PULLPREVIEW_FIRST_RUN',
'PULLPREVIEW_PUBLIC_DNS','TRANSMORPHER_AUTH_TOKEN_HASH','PULLPREVIEW_URL','TRANSMORPHER_DEV_MODE','TRANSMORPHER_STORE_DERIVATIVES',
'TRANSMORPHER_DISK_ORIGINALS','TRANSMORPHER_DISK_IMAGE_DERIVATIVES','TRANSMORPHER_DISK_VIDEO_DERIVATIVES','TRANSMORPHER_SIGNING_KEYPAIR','TRANSMORPHER_OPTIMIZER_TIMEOUT',
'PROTECTOR_AUTH_TOKEN','PROTECTOR_PRIVATE_KEY','PROTECTOR_SERVER_URL','AWS_ACCESS_KEY_ID','AWS_DEFAULT_REGION',
'AWS_USE_PATH_STYLE_ENDPOINT','AWS_BUCKET_ORIGINALS','AWS_BUCKET_IMAGE_DERIVATIVES','AWS_BUCKET_VIDEO_DERIVATIVES','AWS_CLOUDFRONT_DISTRIBUTION_ID',
'SQS_PREFIX','SQS_QUEUE','LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL',
