...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'decoder.nvidia-cuda' => 'array',
            'encoder.cpu-h264' => 'array',
            'encoder.cpu-hevc' => 'array',
            'encoder.nvidia-h264' => 'array',
            'encoder.nvidia-hevc' => 'array',
            ...
            'image-optimizer.timeout' => 'string',
            ...
            'queue.connections.sqs-fifo.driver' => 'string',
            'queue.connections.sqs-fifo.key' => 'string',
            'queue.connections.sqs-fifo.secret' => 'string',
            'queue.connections.sqs-fifo.prefix' => 'string',
            'queue.connections.sqs-fifo.queue' => 'string',
            'queue.connections.sqs-fifo.suffix' => 'NULL',
            'queue.connections.sqs-fifo.region' => 'string',
            'queue.connections.sqs-fifo.after_commit' => 'boolean',
            ...
            'transmorpher.dev_mode' => 'boolean',
            'transmorpher.store_derivatives' => 'boolean',
            'transmorpher.disks.originals' => 'string',
            'transmorpher.disks.imageDerivatives' => 'string',
            'transmorpher.disks.documentDerivatives' => 'string',
            'transmorpher.disks.videoDerivatives' => 'string',
            'transmorpher.transform_class' => 'string',
            'transmorpher.convert_classes.jpg' => 'string',
            'transmorpher.convert_classes.png' => 'string',
            'transmorpher.convert_classes.gif' => 'string',
            'transmorpher.convert_classes.webp' => 'string',
            'transmorpher.document_remove_metadata' => 'boolean',
            'transmorpher.document_default_ppi' => 'integer',
            'transmorpher.transcode_class' => 'string',
            'transmorpher.decoder' => 'string',
            'transmorpher.encoder' => 'string',
            'transmorpher.representations' => 'array',
            'transmorpher.cdn_helper' => 'string',
            'transmorpher.aws.key' => 'string',
            'transmorpher.aws.secret' => 'string',
            'transmorpher.aws.region' => 'string',
            'transmorpher.aws.cloudfront_distribution_id' => 'string',
            'transmorpher.signing_keypair' => 'string',
            'transmorpher.media_handlers.image' => 'string',
            'transmorpher.media_handlers.document' => 'string',
            'transmorpher.media_handlers.video' => 'string',
            'transmorpher.cache_invalidation_counter_file_path' => 'string',
            'transmorpher.upload_handler' => 'string',
            'transmorpher.handler.upload.default.class' => 'string',
            'transmorpher.handler.upload.s3-multi-part.class' => 'string',
            'view.paths' => 'array',
...
'app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.aliases.CdnHelper','app.aliases.Delivery',
'app.aliases.InterventionImage','app.aliases.Optimize','app.aliases.Transcode','app.aliases.Transform','app.aliases.UploadHandler',
...
'cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','chunk-upload.storage.chunks','chunk-upload.storage.disk',
...
'chunk-upload.handlers.custom','chunk-upload.handlers.override','cors.paths','cors.allowed_methods','cors.allowed_origins',
...
'database.redis.cache.backoff_algorithm','database.redis.cache.backoff_base','database.redis.cache.backoff_cap','decoder.nvidia-cuda','encoder.cpu-h264',
'encoder.cpu-hevc','encoder.nvidia-h264','encoder.nvidia-hevc','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.disks.localOriginals.driver','filesystems.disks.localOriginals.root','filesystems.disks.localOriginals.throw','filesystems.disks.localOriginals.report','filesystems.disks.localImageDerivatives.driver',
'filesystems.disks.localImageDerivatives.root','filesystems.disks.localImageDerivatives.throw','filesystems.disks.localImageDerivatives.report','filesystems.disks.localDocumentDerivatives.driver','filesystems.disks.localDocumentDerivatives.root',
'filesystems.disks.localDocumentDerivatives.throw','filesystems.disks.localDocumentDerivatives.report','filesystems.disks.localVideoDerivatives.driver','filesystems.disks.localVideoDerivatives.root','filesystems.disks.localVideoDerivatives.url',
'filesystems.disks.localVideoDerivatives.visibility','filesystems.disks.localVideoDerivatives.throw','filesystems.disks.localVideoDerivatives.report','filesystems.disks.s3Originals.driver','filesystems.disks.s3Originals.root',
'filesystems.disks.s3Originals.key','filesystems.disks.s3Originals.secret','filesystems.disks.s3Originals.region','filesystems.disks.s3Originals.bucket','filesystems.disks.s3Originals.url',
'filesystems.disks.s3Originals.endpoint','filesystems.disks.s3Originals.use_path_style_endpoint','filesystems.disks.s3Originals.throw','filesystems.disks.s3Originals.report','filesystems.disks.s3ImageDerivatives.driver',
'filesystems.disks.s3ImageDerivatives.root','filesystems.disks.s3ImageDerivatives.key','filesystems.disks.s3ImageDerivatives.secret','filesystems.disks.s3ImageDerivatives.region','filesystems.disks.s3ImageDerivatives.bucket',
'filesystems.disks.s3ImageDerivatives.url','filesystems.disks.s3ImageDerivatives.endpoint','filesystems.disks.s3ImageDerivatives.use_path_style_endpoint','filesystems.disks.s3ImageDerivatives.throw','filesystems.disks.s3ImageDerivatives.report',
'filesystems.disks.s3DocumentDerivatives.driver','filesystems.disks.s3DocumentDerivatives.root','filesystems.disks.s3DocumentDerivatives.key','filesystems.disks.s3DocumentDerivatives.secret','filesystems.disks.s3DocumentDerivatives.region',
'filesystems.disks.s3DocumentDerivatives.bucket','filesystems.disks.s3DocumentDerivatives.url','filesystems.disks.s3DocumentDerivatives.endpoint','filesystems.disks.s3DocumentDerivatives.use_path_style_endpoint','filesystems.disks.s3DocumentDerivatives.throw',
'filesystems.disks.s3DocumentDerivatives.report','filesystems.disks.s3VideoDerivatives.driver','filesystems.disks.s3VideoDerivatives.root','filesystems.disks.s3VideoDerivatives.key','filesystems.disks.s3VideoDerivatives.secret',
'filesystems.disks.s3VideoDerivatives.region','filesystems.disks.s3VideoDerivatives.bucket','filesystems.disks.s3VideoDerivatives.url','filesystems.disks.s3VideoDerivatives.endpoint','filesystems.disks.s3VideoDerivatives.use_path_style_endpoint',
'filesystems.disks.s3VideoDerivatives.throw','filesystems.disks.s3VideoDerivatives.report','filesystems.links./var/www/public/storage','filesystems.links./var/www/public/videos','hashing.driver',
'hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.argon.memory','hashing.argon.threads','hashing.argon.time',
'hashing.argon.verify','hashing.rehash_on_login','image.driver','image.options.autoOrientation','image.options.decodeAnimation',
'image.options.blendingColor','image.options.strip','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Jpegoptim','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Pngquant','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Optipng',
...
'protector.fileName','protector.maxPacketLength','protector.baseDirectory','protector.remoteEndpoint.serverUrl','protector.remoteEndpoint.htaccessLogin',
'protector.dumpEndpointRoute','protector.routeMiddleware','protector.chunkSize','protector.httpTimeout','queue.default',
...
'queue.connections.sqs-fifo.driver','queue.connections.sqs-fifo.key','queue.connections.sqs-fifo.secret','queue.connections.sqs-fifo.prefix','queue.connections.sqs-fifo.queue',
'queue.connections.sqs-fifo.suffix','queue.connections.sqs-fifo.region','queue.connections.sqs-fifo.after_commit','queue.batching.database','queue.batching.table',
...
'session.http_only','session.same_site','session.partitioned','transmorpher.dev_mode','transmorpher.store_derivatives',
'transmorpher.disks.originals','transmorpher.disks.imageDerivatives','transmorpher.disks.documentDerivatives','transmorpher.disks.videoDerivatives','transmorpher.transform_class',
'transmorpher.convert_classes.jpg','transmorpher.convert_classes.png','transmorpher.convert_classes.gif','transmorpher.convert_classes.webp','transmorpher.document_remove_metadata',
'transmorpher.document_default_ppi','transmorpher.transcode_class','transmorpher.decoder','transmorpher.encoder','transmorpher.representations',
'transmorpher.cdn_helper','transmorpher.aws.key','transmorpher.aws.secret','transmorpher.aws.region','transmorpher.aws.cloudfront_distribution_id',
'transmorpher.signing_keypair','transmorpher.media_handlers.image','transmorpher.media_handlers.document','transmorpher.media_handlers.video','transmorpher.cache_invalidation_counter_file_path',
'transmorpher.upload_handler','transmorpher.handler.upload.default.class','transmorpher.handler.upload.s3-multi-part.class','view.paths','view.compiled',
...
'v2.getImageDerivativeForVersion','v2.getDocumentOriginal','v2.getDocumentDerivativeForVersion','v2.reserveUploadSlot','v2.getUploadUrl',
'v2.completeUpload','v2.abortUpload','v2.upload','v2.getPublicKey','v2.getCacheInvalidator',
'v2.getUploadHandler','getImageDerivative','getDocumentDerivative','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'errors.400','welcome','laravel-exceptions::401','laravel-exceptions::402','laravel-exceptions::403',
...
'responses.upload.abort.success','responses.upload.abort.failed','responses.upload.slot.created','responses.upload.slot.failed','responses.upload.image.success',
'responses.upload.video.success','responses.upload.document.success','responses.image.version.set.success','responses.video.transcoding.success','responses.video.transcoding.aborted',
'responses.video.transcoding.failed','responses.video.transcoding.job_dispatch_failed','responses.video.version.set.success','responses.document.version.set.success','responses.media.versions.retrieved',
'responses.media.deletion.success','responses.disk.write.failed','version-deprecation-notice.subject','version-deprecation-notice.title','version-deprecation-notice.version_soon_deprecated',
...
'BCRYPT_ROUNDS','TRANSMORPHER_DEV_MODE','TRANSMORPHER_STORE_DERIVATIVES','TRANSMORPHER_SIGNING_KEYPAIR','TRANSMORPHER_UPLOAD_HANDLER',
'TRANSMORPHER_DISK_ORIGINALS','TRANSMORPHER_DISK_IMAGE_DERIVATIVES','TRANSMORPHER_DISK_DOCUMENT_DERIVATIVES','TRANSMORPHER_DISK_VIDEO_DERIVATIVES','TRANSMORPHER_OPTIMIZER_TIMEOUT',
'VIDEO_TRANSCODING_WORKERS_AMOUNT','TRANSMORPHER_VIDEO_ENCODER','TRANSMORPHER_VIDEO_TRANSCODING_QUEUE','TRANSMORPHER_VIDEO_TRANSCODING_QUEUE_CONNECTION','TRANSMORPHER_CLIENT_NOTIFICATIONS_QUEUE',
'TRANSMORPHER_EMAIL_QUEUE','PULLPREVIEW_PUBLIC_DNS','PULLPREVIEW_FIRST_RUN','SEED_USER_NAME','SEED_USER_EMAIL',
'TRANSMORPHER_AUTH_TOKEN_HASH','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_USE_PATH_STYLE_ENDPOINT',
