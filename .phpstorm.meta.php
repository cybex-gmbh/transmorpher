...
'hashing.rehash_on_login','image.driver','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Jpegoptim','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Pngquant','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Optipng',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','protector.fileName',
...
'protector.routeMiddleware','protector.chunkSize','protector.httpTimeout','queue.default','queue.connections.sync.driver',
...
'queue.connections.redis.after_commit','queue.connections.deferred.driver','queue.connections.failover.driver','queue.connections.failover.connections','queue.connections.sqs-fifo.driver',
'queue.connections.sqs-fifo.key','queue.connections.sqs-fifo.secret','queue.connections.sqs-fifo.prefix','queue.connections.sqs-fifo.queue','queue.connections.sqs-fifo.suffix',
'queue.connections.sqs-fifo.region','queue.connections.sqs-fifo.after_commit','queue.batching.database','queue.batching.table','queue.failed.driver',
...
'session.same_site','session.partitioned','transmorpher.dev_mode','transmorpher.store_derivatives','transmorpher.disks.originals',
'transmorpher.disks.imageDerivatives','transmorpher.disks.documentDerivatives','transmorpher.disks.videoDerivatives','transmorpher.transform_class','transmorpher.convert_classes.jpg',
'transmorpher.convert_classes.png','transmorpher.convert_classes.gif','transmorpher.convert_classes.webp','transmorpher.document_remove_metadata','transmorpher.document_default_ppi',
'transmorpher.transcode_class','transmorpher.decoder','transmorpher.encoder','transmorpher.representations','transmorpher.cdn_helper',
'transmorpher.aws.key','transmorpher.aws.secret','transmorpher.aws.region','transmorpher.aws.cloudfront_distribution_id','transmorpher.signing_keypair',
'transmorpher.media_handlers.image','transmorpher.media_handlers.document','transmorpher.media_handlers.video','transmorpher.cache_invalidation_counter_file_path','view.paths',
...
'BCRYPT_ROUNDS','TRANSMORPHER_DEV_MODE','TRANSMORPHER_STORE_DERIVATIVES','TRANSMORPHER_DISK_ORIGINALS','TRANSMORPHER_DISK_IMAGE_DERIVATIVES',
'TRANSMORPHER_DISK_DOCUMENT_DERIVATIVES','TRANSMORPHER_DISK_VIDEO_DERIVATIVES','TRANSMORPHER_SIGNING_KEYPAIR','TRANSMORPHER_OPTIMIZER_TIMEOUT','VIDEO_TRANSCODING_WORKERS_AMOUNT',
...
'SQS_QUEUE','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL',
