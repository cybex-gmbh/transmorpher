...
'filesystems.links./var/www/public/videos','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Jpegoptim','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Pngquant','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Optipng','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Gifsicle',
'image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Cwebp','image-optimizer.binary_path','image-optimizer.timeout','image-optimizer.log_optimizer_activity','intervention-image.driver',
'intervention-image.options.autoOrientation','intervention-image.options.decodeAnimation','intervention-image.options.backgroundColor','intervention-image.options.strip','logging.default',
...
'session.same_site','session.partitioned','session.serialization','transmorpher.app.dev_mode','transmorpher.app.disks.originals',
'transmorpher.app.disks.imageDerivatives','transmorpher.app.disks.documentDerivatives','transmorpher.app.disks.videoDerivatives','transmorpher.app.signing_keypair','transmorpher.app.cdn_class',
'transmorpher.app.upload_handler','transmorpher.queue.video_transcoding.queue','transmorpher.queue.video_transcoding.connection','transmorpher.queue.video_transcoding.use_sqs_fifo','transmorpher.queue.client_notifications.queue',
'transmorpher.queue.client_notifications.connection','transmorpher.queue.client_notifications.use_sqs_fifo','transmorpher.queue.email.queue','transmorpher.queue.email.connection','transmorpher.queue.email.use_sqs_fifo',
...
'PROTECTOR_SERVER_DUMP_ENDPOINT_ROUTE','PROTECTOR_CLIENT_PRIVATE_KEY','PROTECTOR_CLIENT_AUTH_TOKEN','PROTECTOR_CLIENT_DUMP_ENDPOINT_URL','TRANSMORPHER_SIGNING_KEYPAIR',
'AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_USE_PATH_STYLE_ENDPOINT','AWS_BUCKET_ORIGINALS',
'AWS_BUCKET_IMAGE_DERIVATIVES','AWS_BUCKET_DOCUMENT_DERIVATIVES','AWS_BUCKET_VIDEO_DERIVATIVES','AWS_CLOUDFRONT_DISTRIBUTION_ID','SQS_PREFIX',
'LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','LOG_FOLDER',
