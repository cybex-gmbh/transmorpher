...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'Cybex\Protector\Contracts\CrypterContract' => \Cybex\Protector\Classes\SodiumCrypter::class,
            'Cybex\Protector\Contracts\DiskHelperContract' => \Cybex\Protector\Classes\DiskHelper::class,
            'Cybex\Protector\Contracts\ProtectorConfigContract' => \Cybex\Protector\Classes\Config\ProtectorConfig::class,
            'Cybex\Protector\Contracts\ProtectorConfiguratorContract' => \Cybex\Protector\Classes\Config\ProtectorConfigurator::class,
            ...
            'delivery' => \App\Classes\Delivery::class,
            ...
            'media-handler.document' => \App\Classes\MediaHandler\DocumentHandler::class,
            'media-handler.image' => \App\Classes\MediaHandler\ImageHandler::class,
            'media-handler.video' => \App\Classes\MediaHandler\VideoHandler::class,
            ...
            'optimize' => \App\Classes\Optimizer\Optimize::class,
            'pipeline' => \Illuminate\Pipeline\Pipeline::class,
            'protector' => \Cybex\Protector\Protector::class,
            ...
            'transcode' => \App\Classes\Transcode::class,
            'transform' => \App\Classes\Intervention\Transform::class,
            'translation.loader' => \Illuminate\Translation\FileLoader::class,
            'translator' => \Illuminate\Translation\Translator::class,
            'upload-handler' => \App\Classes\UploadHandler\DefaultUploadHandler::class,
            'url' => \Illuminate\Routing\UrlGenerator::class,
            'validation.presence' => \Illuminate\Validation\DatabasePresenceVerifier::class,
            'video.decoder' => \App\Classes\Video\Decoder\CpuDecoder::class,
            'video.encoder' => \App\Classes\Video\Encoder\CpuH264Encoder::class,
    ...
    override(\config(), map([
            ...
            'app.aliases.CdnHelper' => 'string',
            'app.aliases.Decoder' => 'string',
            'app.aliases.Delivery' => 'string',
            'app.aliases.Encoder' => 'string',
            'app.aliases.InterventionImage' => 'string',
            'app.aliases.Optimize' => 'string',
            'app.aliases.Transcode' => 'string',
            'app.aliases.Transform' => 'string',
            'app.aliases.UploadHandler' => 'string',
            ...
            'chunk-upload.logging.enabled' => 'boolean',
            ...
            'filesystems.disks.localOriginals.driver' => 'string',
            'filesystems.disks.localOriginals.root' => 'string',
            'filesystems.disks.localOriginals.throw' => 'boolean',
            'filesystems.disks.localOriginals.report' => 'boolean',
            'filesystems.disks.localImageDerivatives.driver' => 'string',
            'filesystems.disks.localImageDerivatives.root' => 'string',
            'filesystems.disks.localImageDerivatives.throw' => 'boolean',
            'filesystems.disks.localImageDerivatives.report' => 'boolean',
            'filesystems.disks.localDocumentDerivatives.driver' => 'string',
            'filesystems.disks.localDocumentDerivatives.root' => 'string',
            'filesystems.disks.localDocumentDerivatives.throw' => 'boolean',
            'filesystems.disks.localDocumentDerivatives.report' => 'boolean',
            'filesystems.disks.localVideoDerivatives.driver' => 'string',
            'filesystems.disks.localVideoDerivatives.root' => 'string',
            'filesystems.disks.localVideoDerivatives.url' => 'string',
            'filesystems.disks.localVideoDerivatives.visibility' => 'string',
            'filesystems.disks.localVideoDerivatives.throw' => 'boolean',
            'filesystems.disks.localVideoDerivatives.report' => 'boolean',
            'filesystems.disks.s3Originals.driver' => 'string',
            'filesystems.disks.s3Originals.root' => 'string',
            'filesystems.disks.s3Originals.key' => 'string',
            'filesystems.disks.s3Originals.secret' => 'string',
            'filesystems.disks.s3Originals.region' => 'string',
            'filesystems.disks.s3Originals.bucket' => 'string',
            'filesystems.disks.s3Originals.url' => 'NULL',
            'filesystems.disks.s3Originals.endpoint' => 'NULL',
            'filesystems.disks.s3Originals.use_path_style_endpoint' => 'boolean',
            'filesystems.disks.s3Originals.throw' => 'boolean',
            'filesystems.disks.s3Originals.report' => 'boolean',
            'filesystems.disks.s3ImageDerivatives.driver' => 'string',
            'filesystems.disks.s3ImageDerivatives.root' => 'string',
            'filesystems.disks.s3ImageDerivatives.key' => 'string',
            'filesystems.disks.s3ImageDerivatives.secret' => 'string',
            'filesystems.disks.s3ImageDerivatives.region' => 'string',
            'filesystems.disks.s3ImageDerivatives.bucket' => 'string',
            'filesystems.disks.s3ImageDerivatives.url' => 'NULL',
            'filesystems.disks.s3ImageDerivatives.endpoint' => 'NULL',
            'filesystems.disks.s3ImageDerivatives.use_path_style_endpoint' => 'boolean',
            'filesystems.disks.s3ImageDerivatives.throw' => 'boolean',
            'filesystems.disks.s3ImageDerivatives.report' => 'boolean',
            'filesystems.disks.s3DocumentDerivatives.driver' => 'string',
            'filesystems.disks.s3DocumentDerivatives.root' => 'string',
            'filesystems.disks.s3DocumentDerivatives.key' => 'string',
            'filesystems.disks.s3DocumentDerivatives.secret' => 'string',
            'filesystems.disks.s3DocumentDerivatives.region' => 'string',
            'filesystems.disks.s3DocumentDerivatives.bucket' => 'string',
            'filesystems.disks.s3DocumentDerivatives.url' => 'NULL',
            'filesystems.disks.s3DocumentDerivatives.endpoint' => 'NULL',
            'filesystems.disks.s3DocumentDerivatives.use_path_style_endpoint' => 'boolean',
            'filesystems.disks.s3DocumentDerivatives.throw' => 'boolean',
            'filesystems.disks.s3DocumentDerivatives.report' => 'boolean',
            'filesystems.disks.s3VideoDerivatives.driver' => 'string',
            'filesystems.disks.s3VideoDerivatives.root' => 'string',
            'filesystems.disks.s3VideoDerivatives.key' => 'string',
            'filesystems.disks.s3VideoDerivatives.secret' => 'string',
            'filesystems.disks.s3VideoDerivatives.region' => 'string',
            'filesystems.disks.s3VideoDerivatives.bucket' => 'string',
            'filesystems.disks.s3VideoDerivatives.url' => 'NULL',
            'filesystems.disks.s3VideoDerivatives.endpoint' => 'NULL',
            'filesystems.disks.s3VideoDerivatives.use_path_style_endpoint' => 'boolean',
            'filesystems.disks.s3VideoDerivatives.throw' => 'boolean',
            'filesystems.disks.s3VideoDerivatives.report' => 'boolean',
            'filesystems.disks.protector_local.driver' => 'string',
            'filesystems.disks.protector_local.root' => 'string',
            'filesystems.disks.protector_local.serve' => 'boolean',
            'filesystems.disks.protector_local.throw' => 'boolean',
            'filesystems.disks.protector_local.report' => 'boolean',
            'filesystems.disks.protector_storage.driver' => 'string',
            'filesystems.disks.protector_storage.root' => 'string',
            'filesystems.disks.protector_storage.serve' => 'boolean',
            'filesystems.disks.protector_storage.throw' => 'boolean',
            'filesystems.disks.protector_storage.report' => 'boolean',
            'filesystems.links./var/www/public/storage' => 'string',
            'filesystems.links./var/www/public/videos' => 'string',
            'image.driver' => 'string',
            ...
            'protector.fileName' => 'string',
            'protector.maxPacketLength' => 'string',
            'protector.baseDirectory' => 'string',
            'protector.remoteEndpoint.serverUrl' => 'NULL',
            'protector.remoteEndpoint.htaccessLogin' => 'string',
            'protector.dumpEndpointRoute' => 'string',
            'protector.routeMiddleware' => 'array',
            'protector.chunkSize' => 'integer',
            'protector.server.dumpEndpointRoute' => 'string',
            'protector.server.routeMiddleware' => 'array',
            'protector.server.chunkSize' => 'integer',
            'protector.cleanup.local_disk.invokable' => 'string',
            'protector.cleanup.local_disk.mode' => 'string',
            'protector.cleanup.local_disk.schedule' => 'string',
            'protector.client.dumpEndpointUrl' => 'NULL',
            'protector.client.authToken' => 'NULL',
            'protector.client.privateKey' => 'NULL',
            'protector.client.basicAuthCredentials' => 'NULL',
            'protector.client.httpTimeout' => 'integer',
            'protector.dump.fileName' => 'string',
            'protector.dump.maxPacketLength' => 'string',
            'protector.dump.metadata.providers' => 'array',
            'protector.dump.metadata.envValue' => 'NULL',
            'protector.dump.metadata.jsonFilePath' => 'string',
            ...
            'transmorpher.app.dev_mode' => 'boolean',
            'transmorpher.app.disks.originals' => 'string',
            'transmorpher.app.disks.imageDerivatives' => 'string',
            'transmorpher.app.disks.documentDerivatives' => 'string',
            'transmorpher.app.disks.videoDerivatives' => 'string',
            'transmorpher.app.signing_keypair' => 'string',
            'transmorpher.app.cdn_class' => 'string',
            'transmorpher.app.upload_handler' => 'string',
            'transmorpher.queue.video_transcoding.queue' => 'string',
            'transmorpher.queue.video_transcoding.connection' => 'string',
            'transmorpher.queue.video_transcoding.use_sqs_fifo' => 'boolean',
            'transmorpher.queue.client_notifications.queue' => 'string',
            'transmorpher.queue.client_notifications.connection' => 'string',
            'transmorpher.queue.client_notifications.use_sqs_fifo' => 'boolean',
            'transmorpher.queue.email.queue' => 'string',
            'transmorpher.queue.email.connection' => 'string',
            'transmorpher.queue.email.use_sqs_fifo' => 'boolean',
...
'app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.aliases.CdnHelper','app.aliases.Decoder',
'app.aliases.Delivery','app.aliases.Encoder','app.aliases.InterventionImage','app.aliases.Optimize','app.aliases.Transcode',
'app.aliases.Transform','app.aliases.UploadHandler','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'cache.prefix','cache.serializable_classes','chunk-upload.storage.chunks','chunk-upload.storage.disk','chunk-upload.clear.timestamp',
'chunk-upload.clear.schedule.enabled','chunk-upload.clear.schedule.cron','chunk-upload.chunk.name.use.session','chunk-upload.chunk.name.use.browser','chunk-upload.logging.enabled',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.localOriginals.driver','filesystems.disks.localOriginals.root','filesystems.disks.localOriginals.throw',
'filesystems.disks.localOriginals.report','filesystems.disks.localImageDerivatives.driver','filesystems.disks.localImageDerivatives.root','filesystems.disks.localImageDerivatives.throw','filesystems.disks.localImageDerivatives.report',
'filesystems.disks.localDocumentDerivatives.driver','filesystems.disks.localDocumentDerivatives.root','filesystems.disks.localDocumentDerivatives.throw','filesystems.disks.localDocumentDerivatives.report','filesystems.disks.localVideoDerivatives.driver',
'filesystems.disks.localVideoDerivatives.root','filesystems.disks.localVideoDerivatives.url','filesystems.disks.localVideoDerivatives.visibility','filesystems.disks.localVideoDerivatives.throw','filesystems.disks.localVideoDerivatives.report',
'filesystems.disks.s3Originals.driver','filesystems.disks.s3Originals.root','filesystems.disks.s3Originals.key','filesystems.disks.s3Originals.secret','filesystems.disks.s3Originals.region',
'filesystems.disks.s3Originals.bucket','filesystems.disks.s3Originals.url','filesystems.disks.s3Originals.endpoint','filesystems.disks.s3Originals.use_path_style_endpoint','filesystems.disks.s3Originals.throw',
'filesystems.disks.s3Originals.report','filesystems.disks.s3ImageDerivatives.driver','filesystems.disks.s3ImageDerivatives.root','filesystems.disks.s3ImageDerivatives.key','filesystems.disks.s3ImageDerivatives.secret',
'filesystems.disks.s3ImageDerivatives.region','filesystems.disks.s3ImageDerivatives.bucket','filesystems.disks.s3ImageDerivatives.url','filesystems.disks.s3ImageDerivatives.endpoint','filesystems.disks.s3ImageDerivatives.use_path_style_endpoint',
'filesystems.disks.s3ImageDerivatives.throw','filesystems.disks.s3ImageDerivatives.report','filesystems.disks.s3DocumentDerivatives.driver','filesystems.disks.s3DocumentDerivatives.root','filesystems.disks.s3DocumentDerivatives.key',
'filesystems.disks.s3DocumentDerivatives.secret','filesystems.disks.s3DocumentDerivatives.region','filesystems.disks.s3DocumentDerivatives.bucket','filesystems.disks.s3DocumentDerivatives.url','filesystems.disks.s3DocumentDerivatives.endpoint',
'filesystems.disks.s3DocumentDerivatives.use_path_style_endpoint','filesystems.disks.s3DocumentDerivatives.throw','filesystems.disks.s3DocumentDerivatives.report','filesystems.disks.s3VideoDerivatives.driver','filesystems.disks.s3VideoDerivatives.root',
'filesystems.disks.s3VideoDerivatives.key','filesystems.disks.s3VideoDerivatives.secret','filesystems.disks.s3VideoDerivatives.region','filesystems.disks.s3VideoDerivatives.bucket','filesystems.disks.s3VideoDerivatives.url',
'filesystems.disks.s3VideoDerivatives.endpoint','filesystems.disks.s3VideoDerivatives.use_path_style_endpoint','filesystems.disks.s3VideoDerivatives.throw','filesystems.disks.s3VideoDerivatives.report','filesystems.disks.protector_local.driver',
'filesystems.disks.protector_local.root','filesystems.disks.protector_local.serve','filesystems.disks.protector_local.throw','filesystems.disks.protector_local.report','filesystems.disks.protector_storage.driver',
'filesystems.disks.protector_storage.root','filesystems.disks.protector_storage.serve','filesystems.disks.protector_storage.throw','filesystems.disks.protector_storage.report','filesystems.links./var/www/public/storage',
'filesystems.links./var/www/public/videos','image.driver','image.options.autoOrientation','image.options.decodeAnimation','image.options.blendingColor',
'image.options.strip','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Jpegoptim','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Pngquant','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Optipng','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Gifsicle',
'image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Cwebp','image-optimizer.binary_path','image-optimizer.timeout','image-optimizer.log_optimizer_activity','logging.default',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','protector.fileName',
'protector.maxPacketLength','protector.baseDirectory','protector.remoteEndpoint.serverUrl','protector.remoteEndpoint.htaccessLogin','protector.dumpEndpointRoute',
'protector.routeMiddleware','protector.chunkSize','protector.server.dumpEndpointRoute','protector.server.routeMiddleware','protector.server.chunkSize',
'protector.cleanup.local_disk.invokable','protector.cleanup.local_disk.mode','protector.cleanup.local_disk.schedule','protector.client.dumpEndpointUrl','protector.client.authToken',
'protector.client.privateKey','protector.client.basicAuthCredentials','protector.client.httpTimeout','protector.dump.fileName','protector.dump.maxPacketLength',
'protector.dump.metadata.providers','protector.dump.metadata.envValue','protector.dump.metadata.jsonFilePath','queue.default','queue.connections.sync.driver',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','transmorpher.app.dev_mode',
'transmorpher.app.disks.originals','transmorpher.app.disks.imageDerivatives','transmorpher.app.disks.documentDerivatives','transmorpher.app.disks.videoDerivatives','transmorpher.app.signing_keypair',
'transmorpher.app.cdn_class','transmorpher.app.upload_handler','transmorpher.queue.video_transcoding.queue','transmorpher.queue.video_transcoding.connection','transmorpher.queue.video_transcoding.use_sqs_fifo',
'transmorpher.queue.client_notifications.queue','transmorpher.queue.client_notifications.connection','transmorpher.queue.client_notifications.use_sqs_fifo','transmorpher.queue.email.queue','transmorpher.queue.email.connection',
'transmorpher.queue.email.use_sqs_fifo','sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix',
...
'protector.server.dump','sanctum.csrf-cookie','v1.getVersions','v1.delete','v1.setVersion',
'v1.getImageOriginal','v1.getImageDerivativeForVersion','v1.getDocumentOriginal','v1.getDocumentDerivativeForVersion','v1.reserveUploadSlot',
'v1.upload','v1.getPublicKey','v1.getCacheInvalidator','v2.versions.get','v2.media.delete',
'v2.versions.set','v2.images.original.get','v2.images.derivative.get','v2.documents.original.get','v2.documents.derivative.get',
'v2.upload.reserve','v2.upload.url','v2.upload.complete','v2.upload.abort','v2.upload.receive',
'v2.meta.publickey','v2.meta.cache.invalidator','v2.meta.upload.handler','delivery.image',
'delivery.document','storage.local','storage.local.upload',);
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','new-version-notice.subject','new-version-notice.title',
'new-version-notice.new_api_version_released','new-version-notice.update_client_implementations','new-version-notice.check_out_on_github','responses.cdn.invalidation.failed','responses.validation.file.name.invalid',
'responses.validation.file.name.invalid_only_spaces','responses.validation.identifier.non_matching','responses.upload.abort.success','responses.upload.abort.failed','responses.upload.slot.created',
'responses.upload.slot.failed','responses.upload.image.success','responses.upload.video.success','responses.upload.document.success','responses.image.version.set.success',
'responses.video.transcoding.success','responses.video.transcoding.aborted','responses.video.transcoding.failed','responses.video.transcoding.job_dispatch_failed','responses.video.version.set.success',
'responses.document.version.set.success','responses.media.versions.retrieved','responses.media.deletion.success','responses.disk.write.failed','version-deprecation-notice.subject',
'version-deprecation-notice.title','version-deprecation-notice.version_soon_deprecated','version-deprecation-notice.update_client_implementations',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','BCRYPT_ROUNDS',
'TRANSMORPHER_SIGNING_KEYPAIR','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_USE_PATH_STYLE_ENDPOINT',
'AWS_BUCKET_ORIGINALS','AWS_BUCKET_IMAGE_DERIVATIVES','AWS_BUCKET_DOCUMENT_DERIVATIVES','AWS_BUCKET_VIDEO_DERIVATIVES','AWS_CLOUDFRONT_DISTRIBUTION_ID',
'SQS_PREFIX','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL',
'LOG_FOLDER','DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE',
