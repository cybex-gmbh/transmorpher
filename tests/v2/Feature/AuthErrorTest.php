...
class AuthErrorTest extends TestCase
{
    ...
    public static function protectedRouteProvider(): array
    {
        return [
            ...
            'set version' => ['PATCH', '/api/v2/media/placeholder-media/versions/1'],
            'image original' => ['GET', '/api/v2/image/placeholder-media/versions/1/original'],
            'image derivative for version' => ['GET', '/api/v2/image/placeholder-media/versions/1/derivative/q-1'],
            'document original' => ['GET', '/api/v2/document/placeholder-media/versions/1/original'],
            'document derivative for version' => ['GET', '/api/v2/document/placeholder-media/versions/1/derivative/q-1'],
            'reserve upload slot' => ['POST', '/api/v2/image/upload/reserve'],
